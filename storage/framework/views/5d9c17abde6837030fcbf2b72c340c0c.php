<?php $__env->startSection('title', 'Lịch của tôi'); ?>
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 py-8 min-h-[70vh]">
    ...
    <!-- Lọc & Tìm kiếm -->
    <div class="mb-8">
        <form id="filterForm" action="<?php echo e(route('bookings.index')); ?>" method="GET" class="flex flex-col md:flex-row gap-3">
            ...
            <select name="status" onchange="this.form.submit()" 
                ...
                <option value="rejected" <?php echo e(request('status')=='rejected' ? 'selected' : ''); ?>>Bị từ chối</option>
            ...
            <div class="md:w-44 relative">
                ...
                <?php if(request()->anyFilled(['keyword','status','date'])): ?>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        <td class="px-8 py-6">
                            <div class="font-bold text-slate-800"><?php echo e($booking->service->name); ?></div>
                        </td>
                        <td class="px-8 py-6">
                            <div class="text-slate-700 font-medium"><?php echo e($booking->start_time->format('d/m/Y')); ?></div>
                            <div class="text-[#6B8F71] text-sm font-semibold"><?php echo e($booking->start_time->format('H:i')); ?></div>
                        </td>
                        <td class="px-8 py-6 text-center">
                            ...
                            ?>
                            <span class="inline-flex px-4 py-1.5 rounded-full text-xs font-bold border <?php echo e($statusClass); ?>">
        ...
        <div class="md:hidden divide-y divide-slate-100">
            <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('bookings.show', $booking->id)); ?>" class="block p-5 active:bg-slate-50 transition-colors">
                <div class="flex justify-between items-start mb-3">
                    <div class="px-3 py-1 rounded-lg text-[10px] font-bold uppercase border <?php echo e($statusClass); ?>">
                        <?php echo e($booking->status); ?>

                    </div>
                    <div class="text-xs text-slate-400">#<?php echo e($booking->id); ?></div>
                </div>
                <h4 class="font-bold text-slate-800 text-lg mb-1"><?php echo e($booking->service->name); ?></h4>
                <div class="flex items-center gap-4 text-sm text-slate-500">
                    <div class="flex items-center gap-1">
                        ...
                        <?php echo e($booking->start_time->format('d/m/Y')); ?>
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <?php echo e($booking->start_time->format('H:i')); ?>
        ...
        <?php if($bookings->isEmpty()): ?>
            <div class="text-center py-20 px-6">
                ...
                <a href="<?php echo e(route('home')); ?>" class="text-pink-600 text-sm font-semibold mt-2 inline-block">Khám phá dịch vụ ngay →</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN/resources/views/user/bookings/index.blade.php ENDPATH**/ ?>