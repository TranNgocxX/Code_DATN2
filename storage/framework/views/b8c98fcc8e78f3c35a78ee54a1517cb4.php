<?php $__env->startSection('title', 'Q&A - BerryNice Spa'); ?>
...
<section class="bg-[#FDFBF0] text-slate-800">
    ...
    <div class="w-full h-[420px] overflow-hidden">
        <img src="<?php echo e(asset('storage/banners/faq-banner.jpg')); ?>" alt="Hình ảnh spa" class="w-full h-full object-cover">
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN2/resources/views/pages/faq.blade.php ENDPATH**/ ?>