...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between gap-4">
        ...
        <form action="<?php echo e(route('admin.categories.index')); ?>"
            method="GET"
            ...
            <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" placeholder="Tìm kiếm danh mục..."
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center">
                                <?php if($category->logo): ?>
                                    <img src="<?php echo e(asset('storage/'.$category->logo)); ?>"
                        ...
                        <td class="px-6 py-4">
                            <div class="font-semibold text-slate-800"> <?php echo e($category->name); ?> </div>
                        </td>

                        <td class="px-6 py-4 text-sm text-slate-600"> <?php echo e(Str::limit($category->description)); ?> </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>