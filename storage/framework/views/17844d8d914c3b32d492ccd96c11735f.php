            ...
            <div id="qr-payment-info" class="hidden mt-6 rounded-lg border border-green-300 bg-green-50 p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div class="flex justify-center">
                        <img src="<?php echo e(asset('images/payment-qr.jpg')); ?>" alt="QR Thanh toán"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN/resources/views/user/bookings/create.blade.php ENDPATH**/ ?>