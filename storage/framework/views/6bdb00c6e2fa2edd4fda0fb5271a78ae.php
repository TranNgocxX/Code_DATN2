...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col shadow-xl z-20">
        ...
        <nav class="flex-1 mt-4 px-3 custom-scroll overflow-y-auto space-y-1">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/dashboard*') ? 'active-nav' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/categories*') ? 'active-nav' : ''); ?>">
                <i class="fas fa-layer-group w-5"></i>
                <span class="ml-3 text-sm font-medium">Danh mục</span>
            </a>

            <a href="<?php echo e(route('admin.services.index')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/services*') ? 'active-nav' : ''); ?>">
                <i class="fas fa-magic w-5"></i>
                <span class="ml-3 text-sm font-medium">Dịch vụ Spa</span>
            </a>

            <a href="<?php echo e(route('admin.employees.index')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/employees*') ? 'active-nav' : ''); ?>">
                <i class="fas fa-user-friends w-5"></i>
                <span class="ml-3 text-sm font-medium">Đội ngũ nhân viên</span>
            </a>

            <a href="<?php echo e(route('admin.appointments.index')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/appointments*') ? 'active-nav' : ''); ?>">
            ...
            <a href="<?php echo e(route('profile.index')); ?>" class="sidebar-link flex items-center px-4 py-3 rounded-md transition <?php echo e(request()->is('admin/profile*') ? 'active-nav' : ''); ?>">
    ...
    <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shadow-sm">
        ...
        <div class="flex items-center space-x-4 border-l border-slate-100 pl-6">
            <div class="text-right hidden sm:block">
                <p class="text-sm font-bold text-slate-800 leading-tight"><?php echo e(auth()->user()->name); ?></p>
            ...
            <img 
                ...
                src="<?php echo e(auth()->user()->avt ? asset('storage/' . auth()->user()->avt) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=f472b6&color=fff'); ?>" 
        ...
        <main class="flex-1 overflow-y-auto p-8">
            ...
            <div id="toast-success" class="fixed top-5 right-5 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-2xl shadow-2xl border-l-4 border-green-500 transform transition-all duration-500 translate-x-0" role="alert">
                ...
                <div class="ml-3 text-sm font-bold text-slate-700"><?php echo e(session('success')); ?></div>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN2/resources/views/layouts/admin.blade.php ENDPATH**/ ?>