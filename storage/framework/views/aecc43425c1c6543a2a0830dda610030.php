<?php $__env->startSection('title', 'Giới thiệu - BerryNice Spa'); ?>
...
<section class="bg-[#FDFBF0] text-slate-800">
    ...
    <div class="w-full h-[420px] overflow-hidden">
        <img src="<?php echo e(asset('storage/banners/about-banner.jpeg')); ?>" alt="Không gian spa" class="w-full h-full object-cover">
    </div>
    ...
    <div class="max-w-6xl mx-auto px-6 py-20 space-y-16">
        <div class="grid md:grid-cols-2 gap-16 items-center">
            <div>
                <img src="<?php echo e(asset('storage/banners/about-story-1.jpeg')); ?>" alt="Phòng trị liệu" class="rounded-2xl shadow-lg">
            </div>
            <div>
        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-1 md:order-2">
                <img src="<?php echo e(asset('storage/banners/about-story-2.jpeg')); ?>" alt="Không gian spa sang trọng" class="rounded-2xl shadow-lg">
            </div>
        </div>

        <div class="grid md:grid-cols-2 gap-16 items-center">
            <div>
                <img src="<?php echo e(asset('storage/banners/about-story-3.jpeg')); ?>" alt="Khu vực tiếp khách" class="rounded-2xl shadow-lg">
            </div>
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN2/resources/views/pages/about.blade.php ENDPATH**/ ?>