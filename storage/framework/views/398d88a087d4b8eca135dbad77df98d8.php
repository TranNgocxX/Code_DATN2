        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-4">
                <div class="bg-white rounded-3xl shadow p-8 text-center sticky top-6">
                    <div class="relative w-40 h-40 mx-auto">
                        <div id="avatar-preview" class="w-40 h-40 rounded-3xl overflow-hidden border-4 border-white shadow-md">
                            <?php if(auth()->user()->avt): ?>
                                <img src="<?php echo e(asset('storage/' . auth()->user()->avt)); ?>" 
                    ...
                    <h2 class="mt-6 text-2xl font-semibold text-gray-800"><?php echo e(auth()->user()->name); ?></h2>
            ...
            <div class="lg:col-span-8">
                <div class="bg-white rounded-3xl shadow p-8">
                    ...
                    <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data" id="profile-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="birthday" value="<?php echo e(old('birthday', auth()->user()->birthday ?? '')); ?>"
                                       class="w-full px-5 py-3.5 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition">
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full px-5 py-3.5 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition"><?php echo e(old('address', auth()->user()->address ?? '')); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN/resources/views/admin/profile.blade.php ENDPATH**/ ?>