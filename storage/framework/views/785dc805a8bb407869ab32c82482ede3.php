...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        <form action="<?php echo e(route('admin.services.index')); ?>" method="GET" class="flex flex-col sm:flex-row items-center gap-3 w-full">
            ...
            <div class="relative w-full sm:max-w-md">
                ...
                <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" placeholder="Tìm kiếm dịch vụ..."
            ...
            <?php if(request('keyword') || request('category_id')): ?>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-6 py-5 font-medium text-slate-800"><?php echo e($service->id); ?></td>
                    <td class="px-6 py-5 font-medium text-slate-800"><?php echo e($service->name); ?></td>
                    <td class="px-6 py-5 text-slate-600"><?php echo e($service->category->name ?? '—'); ?></td>
                    <td class="px-6 py-5 text-center"><?php echo e($service->duration); ?> phút</td>
                    <td class="px-6 py-5 text-center font-medium"><?php echo e($service->max_slot); ?></td>
                    <td class="px-6 py-5 text-right font-semibold text-emerald-600"><?php echo e(number_format($service->price)); ?>đ</td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN2/resources/views/admin/services/index.blade.php ENDPATH**/ ?>