        ...
        <section class="max-w-2xl mx-auto text-gray-700 leading-8 space-y-5 text-[15px] md:text-base">
            ...
            <p>
                ...
                <span class="font-bold text-emerald-700">
                    <?php echo e($booking->appointmentDetail->customer_name); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN/resources/views/user/bookings/success.blade.php ENDPATH**/ ?>