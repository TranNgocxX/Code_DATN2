...
<div class="max-w-4xl mx-auto px-6 py-12 bg-[#FDFBF0]">
    ...
    <form action="<?php echo e(route('bookings.store')); ?>" method="POST" id="booking-form">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-10 p-6 bg-[#DDEAD1] rounded">
            ...
            <h3 class="text-xl font-semibold"><?php echo e($service->name); ?></h3>
            <p class="text-green-700 mt-1">
                <?php echo e($service->duration); ?> phút • <?php echo e(number_format($service->price)); ?>đ
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <input type="date" 
                       ...
                       class="w-full px-5 py-4 border <?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-green-300 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> focus:border-green-600 outline-none bg-white">
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="start_time" id="selected-start-time" value="<?php echo e(old('start_time')); ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div>
                ...
                <input type="text" name="customer_name"
                       value="<?php echo e(old('customer_name', auth()->check() ? auth()->user()->name : '')); ?>"
                       class="w-full px-5 py-4 border <?php $__errorArgs = ['customer_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-green-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="email" name="email"
                       ...
                       class="w-full px-5 py-4 border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-green-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="phone"
                       ...
                       class="w-full px-5 py-4 border <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-green-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="address"
                       ...
                       class="w-full px-5 py-4 border <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-green-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-8">
            ...
            <textarea name="health_status" rows="2" 
                      class="w-full px-5 py-4 border border-green-300 focus:border-green-600 outline-none bg-white"><?php echo e(old('health_status')); ?></textarea>
        </div>

        <div class="mt-8">
            <label class="block text-sm font-semibold text-slate-700 mb-2">Ghi chú thêm</label>
            <textarea name="notes" rows="3" 
                      class="w-full px-5 py-4 border border-green-300 focus:border-green-600 outline-none bg-white"><?php echo e(old('notes')); ?></textarea>
        </div>
...
// phía dưới vừa thêm chưa chạy thử
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadTimeSlots(date) {
        ...
        try {
            ...
            slots.forEach(slot => {
                ...
                if (slot.available) {
                    // Kiểm tra nếu slot này trùng với slot đã chọn trước khi reload trang (old value)
    ...
    // CHÌA KHÓA: Nếu đã có ngày do Laravel trả về (Old Validation), tự động load luôn khung giờ
    if (dateInput.value) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/datn6/resources/views/user/bookings/create.blade.php ENDPATH**/ ?>