<footer class="bg-[#517D50] text-[#FDFBF0]/80 font-light">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('services.category', $category)); ?>" class="hover:text-white hover:underline decoration-[#8FAF8C] underline-offset-4 transition-all duration-300">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href ="<?php echo e(route('home')); ?>" class="hover:text-[#8FAF8C] transition">Trang chủ</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="hover:text-[#8FAF8C] transition">Về chúng tôi</a></li>
                    <li><a href="<?php echo e(route('faq')); ?>" class="hover:text-[#8FAF8C] transition">Q&A</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-[#8FAF8C] transition">Liên hệ</a></li>
                </ul>
            </div>
    ...
    <div class="border-t border-[#FDFBF0]/10 py-6 text-center text-xs text-[#FDFBF0]/50">
        <p>© <?php echo e(date('Y')); ?> BerryNice Spa. All rights reserved.</p>
    </div>
</footer><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Code_DATN2/resources/views/layouts/footer.blade.php ENDPATH**/ ?>